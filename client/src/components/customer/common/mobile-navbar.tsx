...
import { Heart, LogInIcon, LogOut,  Menu,    ShoppingBag,  ShoppingCart, Store, User, type LucideIcon } from "lucide-react";
    ...
    return <section className={drawerSection}>
        ...
        <div className={drawerItemsWrap}>
            {items.map(item => {
                ...
                return <Link to={item.href} key={item.label} className={drawerItemLink}>
...
export function CustomerMobileNavbar({isSignedIn}: CustomerMobileNavbarProps){
    ...
    [{label: "Account", href: "/account", icon: User},
        ...
        {
            label : 'Login', href : "/sign-in", icon : LogInIcon
        }
    ]
