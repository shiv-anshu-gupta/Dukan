...
export function ProductTable({products,onEdit,loading} : ProductsTableProps){
    console.log("ProductTable received:", { products, loading });
            ...
            <TableBody>
                    {
                        loading ? 
                        <TableRow>
                            <TableCell colSpan={9} className={stateCellClass}>
                                Loading Products...
                            </TableCell>
                        </TableRow> :
                        products.length === 0 ? 
