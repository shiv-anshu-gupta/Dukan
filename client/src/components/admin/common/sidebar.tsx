import { BadgePercent, BarChart3, LayoutDashboard, Package, Settings2, Sidebar, Store, type LucideIcon } from "lucide-react";
...
export function AdminSidebar(){
    ...
    return <aside className={sidebarRoot}>
        <div className={brandRow}>
            <div className="flex items-center gap-3">
                <Store className="w-10 h-10"/>
                <span className="text-[25px] font-semibold text-foreground">Dukaan</span>
            </div>
        </div>
